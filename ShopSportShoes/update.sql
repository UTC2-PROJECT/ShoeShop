...
VALUES (N'20220105093241_InitDb', N'5.0.13')
/

ALTER TABLE "Image" ADD "ImageSoure" blob
/

INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
VALUES (N'20220105094008_UpdateDb', N'5.0.13')
/

ALTER TABLE "Image" DROP COLUMN "ImageSoure"
/

INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
VALUES (N'20220105131429_UpdateDb2', N'5.0.13')
/

ALTER TABLE "Image" DROP COLUMN "ImageName"
/

ALTER TABLE "Image" DROP COLUMN "ThumbnailLink"
/

ALTER TABLE "Image" ADD "ImageSource" NCLOB
/

INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
VALUES (N'20220105133814_UpdateDb3', N'5.0.13')
/
